...
L['options_icons_fighter_desc'] = 'Muestra las ubicaciones de élites de {object:Anochecer} para el logro {achievement:41999}.'
L['suspicious_document_label'] = 'Documento sospechoso'
L['suspicious_document_note'] = 'Abre el {object:Documento sospechoso} para invocar una élite de {object:Anochecer}.'
...
L['options_icons_karesh_lore_hunter_desc'] = 'Muestra dónde están los objetos históricos para el logro {achievement:60890}.'

L['options_icons_purrkins'] = '{achievement:42729}'
L['options_icons_purrkins_desc'] = 'Muestra dónde están los purrkins para el logro {achievement:42729}.'
L['purrkins_note'] = 'Acaricia al purrkin con {emote:/acariciar}.'
L['kareshire_sublabel'] = 'Aparece y desaparece.'
L['in_a_tree'] = 'Arriba en un árbol.'
L['little_ms_phaser_sublabel'] = 'Aparece y desaparece.'

L['mailroom_distribution_note'] = 'Interactúa con el carro afuera y luego abre la puerta de la Sala de Correo. Párate en los círculos y usa el botón de acción extra. El tesoro aparecerá cerca de la puerta.'
L['gift_of_the_brothers_note'] = 'Interactúa con la {object:Linterna parpadeante} y habla con {npc:233881}, luego busca a {npc:234112} ({dot:Red}), {npc:234113} ({dot:Yellow}) y {npc:234075} ({dot:Green}), después regresa con {npc:233881} en la {object:Linterna parpadeante}.'
L['ancient_coffer_note'] = 'Recoge el {item:233794} ({dot:Red}) y el {item:233799} ({dot:Yellow}) y luego regresa al {object:Cofre antiguo} para recibir el {item:245269}.'

L['sthaarbs_note'] = 'Usa el teletransportador cerca del {object:Conducto de fase} para llegar a {npc:234845}.'
