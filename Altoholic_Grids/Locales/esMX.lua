...
L["Up to %s"] = "Hasta %s"
L["Shift+Left click to link"] = "Masyús+Clic izquierdo para enlazar"
L["%s is %s with %s (%d/%d)"] = "%s es %s con %s (%d/%d)"

-- ** Currenciess **
L["Not encountered"] = "No encontrado"
...
-- ** Sets **
L["Fetching item information .."] = "Recuperando información del objeto..."