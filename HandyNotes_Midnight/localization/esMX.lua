...
L['options_icons_delve_rewards'] = 'Recompensas de abismos'
L['options_icons_delve_rewards_desc'] = 'Muestra dónde hay recompensas de {location:Abismos} en las descripciones.'
...
L['skyriding_glyph'] = 'Glifo de aeronáutica'
