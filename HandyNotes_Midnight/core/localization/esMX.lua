...
L['requirement_not_found'] = 'Requisito no encontrado'
L['multiple_spawns'] = 'Múltiples apariciones'
L['shared_drops'] = 'Botín compartido'
L['zone_drops_label'] = 'Botín de la zona'
L['zone_drops_note'] = 'Este botín puede obtenerse de varias fuentes en esta zona.'

L['poi_entrance_label'] = 'Entrada'
L['change_map'] = 'Cambiar mapa'

L['requires'] = 'Requiere'
L['ranked_research'] = 'Investigación con rango'

L['focus'] = 'Enfocar'
L['retrieving'] = 'Recuperando el enlace del objeto...'
...
L['achievement'] = 'Logro'
L['decor_owned'] = 'Decoración obtenida'
