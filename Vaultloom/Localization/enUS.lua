...
local enUS = {
    ...
    SUBTAB_MYTHICPLUS_SEASON2 = "Season 2",
    ...
    SETTINGS_WORLD_MAP_BUTTON = "World map button",
    SETTINGS_WORLD_MAP_BUTTON_SHOW = "Show",
    SETTINGS_WORLD_MAP_BUTTON_HIDE = "Hide",
    ...
    NEWS_ENTRIES = {
        {
            ...
            date = "July 19, 2026",
            items = {
                "FIXED: Fixed a bug when opening the Travel Bar button options.",
            },
        },
        {
            version = "0.9.99",
            date = "July 18, 2026",
            items = {
                "FIXED: The Vaultloom world map button now positions itself below existing map buttons and uses Krowi's World Map Buttons when available.",
                "ADDED: A separate option can now show or hide the world map button independently from the minimap button.",
            },
        },
        {
            version = "0.9.98",
    ...
    FEATURE_TRAVEL_BAR_RUNTIME_TOOLTIP_BUTTON_MENU = "Right click a button: open button settings",
    FEATURE_TRAVEL_BAR_RUNTIME_TOOLTIP_MAIN_USE = "Left click: use a random hearthstone",
    FEATURE_TRAVEL_BAR_RUNTIME_TOOLTIP_MAIN_MENU = "Right click: open button settings",
    FEATURE_TRAVEL_BAR_RUNTIME_TOOLTIP_DIRECT_USE = "Left click: use this travel option",
    FEATURE_TRAVEL_BAR_RUNTIME_TOOLTIP_DIRECT_MENU = "Right click: open button settings",
    FEATURE_TRAVEL_BAR_RUNTIME_TOOLTIP_MORE_USE = "Left click: use the selected travel option",
    FEATURE_TRAVEL_BAR_RUNTIME_TOOLTIP_MORE_MENU = "Right click: open button settings",
...
enUS.MAIN_TAB_DUNGEONS_SEASON2 = "Season 2"
...
enUS.DUNGEON_JOURNAL_SEASON2_SUBTITLE = "Choose a Season 2 dungeon."
enUS.DUNGEON_JOURNAL_SEASON2_FALLBACK_DESCRIPTION = "Season 2 dungeons will appear here once Mythic+ and Encounter Journal data are available."
enUS.SEASON_TWO_DUNGEON_ALTAR_OF_FANGS = "Altar of Fangs"
enUS.SEASON_TWO_DUNGEON_MURDER_ROW = "Murder Row"
enUS.SEASON_TWO_DUNGEON_DEN_OF_NALORAKK = "Den of Nalorakk"
enUS.SEASON_TWO_DUNGEON_THE_BLINDING_VALE = "The Blinding Vale"
enUS.SEASON_TWO_DUNGEON_VOIDSCAR_ARENA = "Voidscar Arena"
enUS.SEASON_TWO_DUNGEON_KINGS_REST = "Kings' Rest"
enUS.SEASON_TWO_DUNGEON_RUBY_LIFE_POOLS = "Ruby Life Pools"
enUS.SEASON_TWO_DUNGEON_TEMPLE_OF_SETHRALISS = "Temple of Sethraliss"
...
enUS.SETTINGS_WORLD_MAP_BUTTON = "World map button"
enUS.SETTINGS_WORLD_MAP_BUTTON_SHOW = "Show"
enUS.SETTINGS_WORLD_MAP_BUTTON_HIDE = "Hide"
...
enUS.COMPENDIUM_STANDING_HONORED = "Honored"
...
enUS.COMPENDIUM_DETAIL_JANALAI_HATCHLING_QUESTLINE = "Jan'alai hatchling questline"
enUS.COMPENDIUM_QUEST_RELICS_IN_LOYAL_HANDS = "Relics in Loyal Hands"
enUS.COMPENDIUM_QUEST_HISTORY_LESSON = "History Lesson"
enUS.COMPENDIUM_QUEST_FROM_DARKNESS_LIGHT = "From Darkness, Light"
enUS.COMPENDIUM_QUEST_THE_BATTLE_OF_THE_BRIDGE = "The Battle of the Bridge"
enUS.COMPENDIUM_QUEST_DEAD_END = "Dead End"
...
enUS.COMPENDIUM_VENDOR_THRAXADAR = "Thraxadar"
