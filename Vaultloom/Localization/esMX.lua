...
esMX.FEATURE_AUTO_SELL_JUNK_TITLE = "Venta automática de basura"
esMX.FEATURE_AUTO_SELL_JUNK_DESCRIPTION = "Vende automáticamente objetos grises cuando un vendedor normal puede comprar objetos."
esMX.FEATURE_AUTO_SELL_JUNK_NOTE = "Solo vende objetos grises con valor de vendedor. Omite objetos de misión y ventanas de vendedor no estándar."
esMX.FEATURE_AUTO_SELL_JUNK_PREVIEW_LABEL = "Vendedor"
esMX.FEATURE_AUTO_SELL_JUNK_PREVIEW_NOTE = "Abre un vendedor válido y Vaultloom vende los objetos grises de tus bolsas en una cola segura corta."
esMX.FEATURE_AUTO_SELL_JUNK_SOLD_FORMAT = "%d objetos grises vendidos por %s."
esMX.FEATURE_AUTO_ACCEPT_QUESTS_TITLE = "Aceptar misiones automáticamente"
esMX.FEATURE_AUTO_ACCEPT_QUESTS_DESCRIPTION = "Acepta automáticamente misiones disponibles de PNJ y ventanas de misión."
esMX.FEATURE_AUTO_ACCEPT_QUESTS_PREVIEW_LABEL = "PNJ de misión"
esMX.FEATURE_AUTO_ACCEPT_QUESTS_PREVIEW_NOTE = "Abre misiones disponibles de PNJ y acepta automáticamente la ventana de misión."
esMX.FEATURE_AUTO_ACCEPT_QUESTS_TRIVIAL_LABEL = "Nivel bajo"
esMX.FEATURE_AUTO_ACCEPT_QUESTS_TRIVIAL_INCLUDE = "Todas"
esMX.FEATURE_AUTO_ACCEPT_QUESTS_TRIVIAL_SKIP = "Omitir grises"
esMX.FEATURE_AUTO_ACCEPT_QUESTS_TURNIN_LABEL = "Entrega"
esMX.FEATURE_AUTO_ACCEPT_QUESTS_TURNIN_OFF = "Solo aceptar"
esMX.FEATURE_AUTO_ACCEPT_QUESTS_TURNIN_ON = "Entrega activa"
esMX.FEATURE_MIDNIGHT_RARE_MAP_PINS_TITLE = "Iconos de raros de Midnight"
esMX.FEATURE_MIDNIGHT_RARE_MAP_PINS_DESCRIPTION = "Muestra los raros de Midnight pendientes en el mapa del mundo de Blizzard."
esMX.FEATURE_MIDNIGHT_RARE_MAP_PINS_NOTE = "Usa el icono de viñeta de raro de Blizzard. Los marcadores desaparecen tras obtener el crédito diario del personaje y vuelven tras el reinicio diario."
esMX.FEATURE_MIDNIGHT_RARE_MAP_PINS_PREVIEW_LABEL = "Mapa del mundo"
esMX.FEATURE_MIDNIGHT_RARE_MAP_PINS_PREVIEW_NOTE = "Ubicaciones de raros de Midnight con ocultación diaria y puntos de ruta de Blizzard."
esMX.FEATURE_MIDNIGHT_RARE_MAP_PINS_TOGGLE_TOOLTIP = "Muestra u oculta los raros de Midnight pendientes en el mapa del mundo de Blizzard."
esMX.FEATURE_MIDNIGHT_RARE_MAP_PINS_TOOLTIP_HINT = "Clic izquierdo para colocar un punto de ruta de Blizzard."
esMX.FEATURE_MIDNIGHT_RARE_MAP_PINS_HIDE_DONE_HINT = "Los marcadores desaparecen cuando se obtiene el crédito diario."
...
esMX.FEATURE_AUTO_ACCEPT_QUESTS_NOTE = "Acepta misiones automáticamente. La entrega opcional solo completa misiones claramente seguras y omite elección de recompensa, costes, repetibles y entregas de NPC ambiguas. Mantén Alt para pausarlo brevemente."
