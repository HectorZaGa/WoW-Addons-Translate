...
local esMX = {
    ...
    SUBTAB_MYTHICPLUS_SEASON2 = "Temporada 2",
    ...
    SETTINGS_WORLD_MAP_BUTTON = "Botón del mapa del mundo",
    SETTINGS_WORLD_MAP_BUTTON_SHOW = "Mostrar",
    SETTINGS_WORLD_MAP_BUTTON_HIDE = "Ocultar",
