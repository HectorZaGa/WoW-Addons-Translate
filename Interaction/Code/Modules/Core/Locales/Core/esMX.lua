...
local function Load()
	...
	do
		...
		L["Checkbox - Always Show Gossip Frame"] = "Mostrar siempre el marco de chismes"
		L["Checkbox - Always Show Gossip Frame - Tooltip"] = "Siempre muestra el marco de chismes cuando está disponible en lugar de solo después del diálogo.\n\nPor defecto: Activado."
		L["Title - Quest"] = "Misión"
		...
		L["Keybind - PC / Keybind / Close"] = "Cerrar"
		L["Keybind - PC / Keybind / Close - Tooltip"] = "Acceso directo para cerrar la ventana de interacción activa.\n\nPor defecto: ESCAPE."
		...
		L["Title - Special Credits"] = "Reconocimientos especiales"
		L["Title - Special Credits / MrFIXIT"] = "MrFIXIT | Código - Correcciones de errores y mejoras significativas"
		L["Title - Special Credits / MrFIXIT - Tooltip"] = "Agradecimientos especiales a MrFIXIT por las extensas correcciones de errores y mejoras."

		L["Title - Credits"] = "Agradecimientos"
		...
		L["Title - Credits / huchang47"] = "huchang47 | Traducción - Chino (Simplificado)"
		L["Title - Credits / huchang47 - Tooltip"] = "Agradecimientos especiales a huchang47 por las traducciones al Chino (Simplificado)!"
		L["Title - Credits / muiqo"] = "muiqo | Traducción - Alemán"
		L["Title - Credits / muiqo - Tooltip"] = "Agradecimientos especiales a muiqo por las traducciones al Alemán!"
	...
	do
		do -- LIBRARY
			-- PROMPTS
			L["Readable - Library - Prompt - Delete - Local"] = "Esto eliminará permanentemente este registro de tu biblioteca del jugador."
			L["Readable - Library - Prompt - Delete - Global"] = "Esto eliminará permanentemente este registro de la biblioteca de la tropa."
			L["Readable - Library - Prompt - Delete Button 1"] = "Eliminar"
			L["Readable - Library - Prompt - Delete Button 2"] = "Cancelar"

			L["Readable - Library - Prompt - Import - Local"] = "Importar un estado guardado sobrescribirá tu biblioteca del jugador."
			L["Readable - Library - Prompt - Import - Global"] = "Importar un estado guardado sobrescribirá la biblioteca de la tropa."
			L["Readable - Library - Prompt - Import Button 1"] = "Importar y recargar"
			L["Readable - Library - Prompt - Import Button 2"] = "Cancelar"

			L["Readable - Library - TextPrompt - Import - Local"] = "Importar a la biblioteca del jugador"
			L["Readable - Library - TextPrompt - Import - Global"] = "Importar a la biblioteca de la tropa"
			...
			L["Readable - Library - TextPrompt - Export - Local"] = "Copiar datos del jugador al portapapeles"
			L["Readable - Library - TextPrompt - Export - Global"] = "Copiar datos de la tropa al portapapeles"
			...
			L["Readable - Library - Name Text - Local - Subtext 2"] = "de la biblioteca"
			L["Readable - Library - Showing Status Text - Subtext 1"] = "Mostrar"
			L["Readable - Library - Showing Status Text - Subtext 2"] = " Objetos"
	...
	do
		do -- BtWQuests
			...
			L["SupportedAddons - BtWQuests - Tooltip - Call to Action"] = addon.Theme.RGB_ORANGE_HEXCODE .. "Haz clic para abrir la cadena de misiones en BtWQuests" .. "|r"
		end
	end
end
