...
L["Left-click to %sopen"] = "Clic izquierdo para %sabrir"
L["Right-click to %sdrag"] = "Clic derecho para %sdesplazar"

L["NEW_VERSION_AVAILABLE"] = "Una nueva versión de Altoholic está disponible, considera actualizar para obtener las últimas funciones."
L["OFFICIAL_SOURCES"] = "Fuentes oficiales: Curseforge y WoW Interface"
...
L["AUCTION_HOUSE_NOT_VISITED_WARNING"] = "No se han revisado las subastas en %s|r desde hace %d días, ¡revisa la casa de subastas y tu buzón!"
...
L["%sTransferring item %s%d|r/%s%d|r"] = "%sTransfiriendo objeto %s%d|r/%s%d|r"
...
L["Getting table of content from %s"] = "Obteniendo tabla de contenidos de %s"
...
L["SHARING_TOC_RECEIVED"] = "|cFFFFFFFFTabla de contenidos recibida (|r|cFF00FF00%d|r |cFFFFFFFFobjetos)|r"
L["SHARING_OPTION_DISABLED"] = "¡Primero debes habilitar el uso compartido de cuentas!"
L["SHARING_INVALID_TARGET"] = "Debes seleccionar un objetivo, o ingresar el nombre del personaje que recibirá la solicitud de compartición"
...
L["Bags"] = "Bolsas"
L["Bank"] = "Banco"
L["Account Bank"] = "Banco de la cuenta"
