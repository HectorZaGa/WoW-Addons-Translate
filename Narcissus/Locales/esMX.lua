...
L["Character UI"] = "Interfaz de personaje";
L["Module Menu"] = "Menú de módulos";
...
L["Add To AddOn Compartment"] = "Agregar al compartimiento de complementos";
...
L["Instruction Remove From To Do List"] = string.format("%s Clic izquierdo para eliminar de la lista de por hacer.", NARCI_MODIFIER_ALT);
L["DIY"] = "DIY";
L["DIY Tab Tooltip"] = "Crear un logro personalizado para fines de captura de pantalla.";
L["Binding Name Open Achievement"] = "Abrir panel de logros de Narcissus";
...
L["Profile"] = "Perfil";
L["Share"] =  SOCIAL_SHARE_TEXT or "Compartir";
...
L["Profile Migration CopyButton Tooltip"] = "Copia este ajuste a tu perfil público.";
...
L["Modify Default Pose Tooltip"] = "Cuando está habilitado, cambia la animación de combate predeterminada de WoW o la animación de montura a \"De pie\" y ajusta la rotación para presentar mejor el objeto.";
